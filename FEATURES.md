# Social Security Administration — Bulk Email Platform
...
- **Social Security Administration branding** — Custom logo in sidebar, top bar, login page, and browser tab (favicon)
...
| 2 | **Per-row CSV import errors** | Most importers silently skip bad rows. Social Security Administration shows you a table of every skipped contact with the exact reason (invalid email, duplicate, already exists), so you fix your data confidently. |
...
| **v1.8.0** | **UI polish — Load Template fix, table layouts (Templates & SMTP), 7 themes, Social Security Administration logo & favicon** |

---

*Built with ❤️ by Social Security Administration*
