...
<img src="public/images/logo.png" alt="Social Security Administration" width="320">
...
**Social Security Administration Bulk Email Platform** is a production-ready, self-hosted email marketing application. Send campaigns through any SMTP server you own — no dependency on Mailchimp, SendGrid, or SES. You control every byte of your data and deliverability infrastructure.
...
```dotenv
APP_NAME="Social Security Administration"
APP_ENV=production
APP_DEBUG=false
...
| v1.1.0 | Social Security Administration rebrand, SMTP encryption, Quill editor sync fixes |
...
| **v1.8.0** | **7 themes, Social Security Administration logo/favicon, table layouts, Load Template fix** |
...
**Built with ❤️ by [Social Security Administration](https://github.com/itsalexwilliam-pixel)**
